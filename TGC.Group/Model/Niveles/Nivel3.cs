...
namespace TGC.Group.Model.Niveles
{
    class Nivel3 : Nivel
    {
        ...
        public override void init(string mediaDir)
        {
            ...
            agregarPared(new TGCVector3(0, 150, 4500), new TGCVector3(1400, 300, 20), arena);   // frente
            ...
            // Plataformas rotantes, en nivel inferior
            pRotantes.Add(new PlataformaRotante(new TGCVector3(-150, 70, 3000), new TGCVector3(200, 50, 200), caja, FastMath.PI * 100));
            pRotantes.Add(new PlataformaRotante(new TGCVector3(150, 70, 3000), new TGCVector3(200, 50, 200), caja, FastMath.PI * (-100)));
